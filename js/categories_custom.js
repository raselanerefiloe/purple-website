...
// Check if cartItems exists in localStorage, if not, initialize as an empty array
let cartItems = JSON.parse(localStorage.getItem("cartItems")) || [];

// Function to add items to the cart
function addToCart(itemId, itemName, price, itemImage = '', itemDescription = '') {
	// Ensure price is a number
    let priceNumber = parseFloat(price);

    if (isNaN(priceNumber)) {
        console.error("Invalid price format for item:", itemName);
